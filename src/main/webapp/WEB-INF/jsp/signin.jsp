      ...
      <form:form class="form-signin" method="post" action="login" modelAttribute="loginForm">
       ...
       <h4 class="logo">Pay My Budy</h4>
        ...
        <p>
          ...
          <form:input  type="text" id="username" name="username" class="form-control" placeholder="Username" required="" autofocus="" path="email"/>
        </p>
        <p>
          <label for="password" class="sr-only">Password</label>
          <form:input type="password" id="password" name="password" class="form-control" placeholder="Password" required="" path="password"/>
