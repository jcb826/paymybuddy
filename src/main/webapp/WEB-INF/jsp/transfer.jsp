    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
      ...
      <body>
        ...
        <div class="container py-3">
          ...
          <div class="flex">
          <!--
            <form:form action="addConnection" method="post" modelAttribute="addConnectionForm">
            ...
            <div>
              <form:form action="tranfer" method="post" class="needs-validation" modelAttribute="transferForm">
                <div class="row g-3">
                  <div class="col-md-5">
